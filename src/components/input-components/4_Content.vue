<template>
    ...
    <QuillEditor theme="snow" style="min-height:300px;" toolbar="full" :placeholder="hint" :title="hint" @ready="onReady" @textChange="textChange"  :disabled="ModalOn" />
</template>
...
import { jsonHTML, jsonTEXT, ModalOn } from "@/share/share"
